...
class ResumeStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'educational_institute.*.title' => ['required', 'string'],
            'educational_institute.*.faculty' => ['required', 'string',],
            'educational_institute.*.specialization' => ['required', 'string'],
            'educational_institute.*.start_year' => ['required'],
            'educational_institute.*.graduation_year' => ['required'],
            'companies' => ['nullable', 'array'],
            'companies.*.name' => ['required', 'string', 'max: 100'],
            'companies.*.position' => ['required', 'string', 'max: 50'],
