...
const CompanyPageEmployeeReviewItem = ({
    id,
    title,
    rating,
    date,
    ...
    return (
        <div key={id} className={s.companyPageEmployeeReviewCardItem}>
            <strong className={s.companyPageEmployeeReviewCardItemTitle}>
                {title}
            </strong>
            <div className={s.companyPageEmployeeReviewCardItemRating}>
                <Rating value={rating} readOnly />
                <span className={s.companyPageEmployeeReviewCardItemRatingDate}>
