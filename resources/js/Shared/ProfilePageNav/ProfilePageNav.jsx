...
export const  ProfilePageNav = () => {
    return (
        <nav className={s.navProfilePage}>
            <AppPage>
                <AppText size='m' bold title={
                    <div className={s.nav}>   
                        <ul className={s.navMenu}>
                            <li href='#' className={s.navLink}>Мои резюме</li>
                            <li href='#' className={s.navLink}>Отклики</li>
                            <li href='#' className={s.navLink}>Помощь</li>
                        </ul>
                        <div className={s.navMenuSerch}>
                            <a href='#'  className={s.navLink}>
                                <BootstrapIcon name={'BsSearch'} size={30} />
                            </a>
                            <div className={s.navLink}>
                                <AppButton variant='outline' size='l'>
                                    <AppText size={'m'} bold title={'Создать резюме'}/>
                                </AppButton> 
                            </div>    
                        </div>
                    </div>
